...
function buildHelpEmbed(pageIndex = 0) {
    ...
    return new EmbedBuilder()
        .setColor('#3498DB')
        .setAuthor({
            name: 'VRChat Community Command Directory',
        ...
        .setFooter({
            text: `Page ${normalizedPage + 1} of ${HELP_CATEGORIES.length} • Use the buttons below to browse • VRChat Community Bot made by Bqbblz`
        })
        .setTimestamp();
...
function buildHelpNavigationRow(requesterId, pageIndex = 0) {
    ...
    return new ActionRowBuilder().addComponents(
        new ButtonBuilder()
            .setCustomId(`help_page:${requesterId}:0`)
            .setLabel('First')
            .setEmoji('⏮️')
            .setStyle(ButtonStyle.Secondary)
        ...
        new ButtonBuilder()
            ...
            .setDisabled(normalizedPage === 0),
        new ButtonBuilder()
            .setCustomId(`help_page_info:${requesterId}:${normalizedPage}`)
            .setLabel(`${normalizedPage + 1} / ${HELP_CATEGORIES.length}`)
            .setStyle(ButtonStyle.Secondary)
            .setDisabled(true),
        new ButtonBuilder()
        ...
        new ButtonBuilder()
            .setCustomId(`help_page:${requesterId}:${lastPage}`)
            .setLabel('Last')
            .setEmoji('⏭️')
            .setStyle(ButtonStyle.Secondary)
            .setDisabled(normalizedPage === lastPage)
